    ...
    return (
        <div className="bg-gray-900 rounded-xl border border-gray-800 p-6 mb-8">
            <div className="flex items-center gap-2 mb-6 border-b border-gray-800 pb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-100">Deck Configuration</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        {['Beginner', 'Intermediate', 'Advanced'].map((level) => (
                            <button
                                ...
                                className={`text-sm py-2 rounded-lg border transition-all ${config.difficulty === level
                ...
                <div className="col-span-1 md:col-span-2 space-y-2">
                    <label className="text-sm font-medium text-gray-300">Focus Areas (Optional)</label>
                    <textarea
