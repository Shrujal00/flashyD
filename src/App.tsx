      ...
      >
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-gray-500">
          <div className="text-center sm:text-left">
            ...
            <span className="ml-2 text-gray-500">· Contributed by{' '}
              <a href="https://github.com/adityanair2509" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-blue-400 font-medium transition-colors">
                Aditya Nair
              </a>
            </span>
          </div>
